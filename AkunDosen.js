  ...
  return (
    <View style={[styles.container, isDarkMode && styles.darkContainer]}>
      <View style={[styles.profileContainer, isDarkMode && styles.darkProfileContainer]}>
        <Image source={require("./assets/Joko.png")} style={styles.profileImage} />
        <Text style={[styles.name, isDarkMode && styles.darkText]}>Joko, S. Kom., M.T.</Text>
        <Text style={[styles.email, isDarkMode && styles.darkText]}>joko@gmail.com</Text>
      </View>
      ...
      <ScrollView style={styles.content}>
        {activeTab === "DataDiri" ? (
          <View style={styles.dataDiri}>
            ...
            <Text style={[styles.label, isDarkMode && styles.darkLabel]}>Joko, S. Kom., M.T.</Text>
            <Text style={[styles.judul_label, isDarkMode && styles.darkJudulLabel]}>Email:</Text>
            <Text style={[styles.label, isDarkMode && styles.darkLabel]}>joko@gmail.com</Text>
            <Text style={[styles.judul_label, isDarkMode && styles.darkJudulLabel]}>NIM:</Text>
            <Text style={[styles.label, isDarkMode && styles.darkLabel]}>108420753221</Text>
