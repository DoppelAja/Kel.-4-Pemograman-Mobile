        ...
        <View style={styles.scrollView}>
          <View style={styles.notificationContainerTitle}>
            <View style={styles.textContainer}>
              <Text style={styles.notificationTitle}>Tugas Baru Masuk</Text>
          ...
          <View style={styles.notificationContainerTitle}>
            <View>
              <Text style={styles.notificationTitle}>Janji Temu Dosen</Text>
          ...
          <View style={styles.notificationContainerTitle}>
            <View>
              <Text style={styles.notificationTitle}>Review Tugas Masuk</Text>
              <Text style={styles.notificationTitle2}>Dari Mahasiswa: Fakhri</Text>
            </View>
            <Image source={require("./assets/IkonNotif.png")} style={styles.menuIconNotif} />
          </View>
