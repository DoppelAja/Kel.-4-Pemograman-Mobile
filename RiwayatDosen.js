...
const RiwayatDosen = () => {
  ...
  const [data, setData] = useState([
    {
      ...
      mahasiswa: "Mahasiswa Bimbingan 1",
      kategori: "Luring",
    },
    {
      date: "18 April 2024",
      title: "Revisi Bab 2",
      mahasiswa: "Mahasiswa Bimbingan 2",
      kategori: "Luring",
    },
  ]);
  ...
  const [dataNewContainer, setDataNewContainer] = useState([
    {
      ...
      mahasiswa: "BAB II M Fakhri Rizqullah",
      kategori: "Daring",
    },
    {
      date: "25 April 2024",
      title: "Revisi Bab I",
      mahasiswa: "BAB I M Fakhri Rizqullah",
      kategori: "Daring",
    },
    {
      date: "30 April 2024",
  ...
  const getPembimbingColor = (mahasiswa) => {
    if (mahasiswa === "Mahasiswa Bimbingan 1") {
      return "#2D9596";
    } else if (mahasiswa === "Mahasiswa Bimbingan 2") {
      return "#663399";
    }
    return "#3498DB";
  };
          ...
          <View style={styles.cardContainer}>
            <View style={styles.cardContent}>
              ...
              <View style={styles.tagContainer}>
                {item.mahasiswa.includes("F") ? (
                  <View style={styles.container2Tag}>
                    <Ionicons name="folder" size={20} color="#FFFFFF" style={styles.iconFolder} />
                    <Text style={[styles.tagTextContainer2, styles.underlineText]}>{item.mahasiswa}</Text>
                  </View>
                ) : (
                  <View style={[styles.supervisorTag, { backgroundColor: getPembimbingColor(item.mahasiswa) }]}>
                    <Text style={[styles.tagText, styles.underlineText]}>{item.mahasiswa}</Text>
                  </View>
                )}
